...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, input_len, segment_ids=None, label_ids=None):
...
def convert_examples_to_features_for_lstm(examples, label_list, max_seq_length, tokenizer,
...
class JDnerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(data_dir, "train_NER_0707.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(data_dir, "valid_NER_0707.txt")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_text(os.path.join(data_dir, "test_NER_0707.txt")), "test")

    def get_labels(self):
        """See base class."""
        # TODO: 根据实际数据进行修改
        return ["X","B-PRODUCT","B-BRAND","B-ADJ","I-PRODUCT","I-BRAND","I-ADJ", "O", "[START]", "[END]"]
